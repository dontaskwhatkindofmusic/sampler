...
const helpPages=[
 ...
 ['record','Tap an empty pad to start; tap again to finish. Or press and hold the empty pad, then release to finish. Capture starts on touch-down; a press lasting 350 ms or more counts as a hold. With threshold enabled it waits for sound first. Microphone access is requested on load and reused until the page closes or you release it in Setup.'],
 ...
 ['samples','Touch several pads together to keep them selected. FX applies to the selected recorded pads. Tap Delete, a pad, then the same pad again to delete. Hold Delete to enter bulk selection; tap Delete again to remove marked pads. Undo restores the entire deletion.'],
