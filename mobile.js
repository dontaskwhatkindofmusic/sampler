...
const helpPages=[
 ...
 ['record','Tap an empty pad to start; tap again to finish. Or press and hold the empty pad, then release to finish. Capture starts on touch-down; a press lasting 350 ms or more counts as a hold. With threshold enabled it waits for sound first. Microphone permission is checked on load. The mic is active only for capture; it is released when idle to preserve playback volume.'],
 ...
 ['samples','Touch several pads together to keep them selected. FX applies to the selected recorded pads. Tap Delete, select a pad, then tap Delete again to remove it. Tap a marked pad to deselect; with no selection the button says Cancel Delete. Hold Delete to enter bulk selection; tap Delete again to remove marked pads. Undo restores the entire deletion.'],
