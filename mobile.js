...
const helpPages=[
 ...
 ['steps','Quantize in Steps snaps new Write Live hits to the grid. Off preserves your timing; ~ marks those hits. Existing notes stay unchanged. Up to 32 steps, in four pages of eight. Keyboard 1–8 addresses the current page; [ / ] changes pages. Select numbered steps, then return to Play and tap a sample. Tap again to remove it from those steps. Use “release steps” before playing freely. Space and keyboard shortcuts still work with a hardware keyboard.'],
 ...
 ['manage','Sample → Manage: choose From and To, then Copy/Paste or Move. Move carries the sample’s notes. Remove From Pattern removes all its notes but keeps the sound. Undo restores the last edit.'],
 ['theme','Setup → Theme follows System by default. Choose Dark or Light to override it. The background and supported browser bars use matching colors.'],
